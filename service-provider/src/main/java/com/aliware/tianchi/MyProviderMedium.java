 ...
 */
public class MyProviderMedium {

    private static final Logger LOGGER = LoggerFactory.getLogger(MyProviderMedium.class);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // 当前应用配置
        application.setName("service-provider-medium");
